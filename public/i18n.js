...
(function () {
  ...
  const T = {
    ...
    "J'ai déjà un serveur Palworld installé (ne pas re-télécharger)": "I already have a Palworld server installed (don't re-download)",
    'Indique directement le dossier qui contient': 'Point directly to the folder that contains',
    ...
    'Dossier du serveur (contient PalServer.exe)': 'Server folder (contains PalServer.exe)',
    "laisse vide pour conserver l'existant": 'leave empty to keep the existing one',
    'Mot de passe admin : 6 caractères minimum si renseigné.': 'Admin password: 6 characters minimum if provided.',
    ...
    'Port de requête (Steam query)': 'Query port (Steam query)',
